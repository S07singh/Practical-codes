...
print("Enter the names of", n, "students (Please press ENTER after entering each student's name) :")
for i in range(0, n):
    ele = input()
...
print("Enter the names of", n, "students who play cricket (Please press ENTER after entering each student's name) :")
for i in range(0, n):
    ele = input()
...
print("Enter the name of", n, "students who play football (Please press ENTER after entering each student's name) :")
for i in range(0, n):
    ele = input()
...
print("Enter the name of", n, "students who play badminton (Please press ENTER after entering each student's name) :")
for i in range(0, n):
    ele = input()
